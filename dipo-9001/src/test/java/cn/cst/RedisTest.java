...
//        redisTemplate.opsForValue().set("wang", MessageTemplate.builder().nickName("王老虎").build());
////        User user = objectMapper.readValue(objectToJson, User.class);
////        System.out.println(user);
//        MessageTemplate wang = redisUtil.getObj("wang",MessageTemplate.class);
